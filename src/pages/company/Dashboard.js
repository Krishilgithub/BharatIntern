...
const CompanyDashboard = () => {
  ...
  useEffect(() => {
    ...
    setStats({
      ...
      shortlistedCandidates: mockApplications.filter(a => a.status === 'Shortlisted').length,
      avgMatchScore: Math.round(mockApplications.reduce((acc, app) => acc + app.matchScore, 0) / mockApplications.length)
    });
  }, []);
  ...
  const getApplicationStatusColor = (status) => {
    switch (status) {
      ...
      case 'Interview Scheduled': return 'text-yellow-600 bg-yellow-100';
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage your internship postings and review applications.</p>
        </div>

        {/* Stats Cards */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          <div className="card text-center">
            <div className="text-3xl font-bold text-primary mb-2">{stats.totalPostings}</div>
            <div className="text-gray-600">Total Postings</div>
          </div>
          <div className="card text-center">
            <div className="text-3xl font-bold text-accent mb-2">{stats.activePostings}</div>
            <div className="text-gray-600">Active Postings</div>
          </div>
          <div className="card text-center">
            <div className="text-3xl font-bold text-yellow-600 mb-2">{stats.totalApplications}</div>
            <div className="text-gray-600">Total Applications</div>
          </div>
          <div className="card text-center">
            <div className="text-3xl font-bold text-green-600 mb-2">{stats.shortlistedCandidates}</div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="card">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <Link to="/company/create-posting" className="card hover:shadow-lg transition-shadow duration-300 group">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                      <Plus className="w-6 h-6 text-primary" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-gray-900">Create New Posting</h3>
                      <p className="text-sm text-gray-600">Post a new internship opportunity</p>
                    </div>
                  </div>
                </Link>

                <Link to="/company/shortlist" className="card hover:shadow-lg transition-shadow duration-300 group">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Shortlist and review candidates</p>
                    </div>
                  </div>
                </Link>
              </div>
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-gray-900">Recent Postings</h2>
                <Link to="/company/create-posting" className="text-primary hover:text-blue-700 font-medium">
                  View All
                </Link>
              </div>
              <div className="space-y-4">
                {postings.slice(0, 3).map((posting) => (
                  <div key={posting.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-sm transition-shadow">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-6 text-sm text-gray-600">
                          <div className="flex items-center space-x-1">
                            ...
                            <span>{posting.applicationsCount} applications</span>
                          </div>
                          <div className="flex items-center space-x-1">
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link to="/company/shortlist" className="text-primary hover:text-blue-700 text-sm">
                  View All
                </Link>
              </div>
                ...
                {applications.slice(0, 5).map((app) => (
                  <div key={app.id} className="flex items-center justify-between py-2">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 text-xs">{app.postingTitle}</p>
                    </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-gray-900">
                    {stats.totalApplications > 0 ? Math.round((stats.shortlistedCandidates / stats.totalApplications) * 100) : 0}%
                  </span>
                </div>
                <div className="flex items-center justify-between">

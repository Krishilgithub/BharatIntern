...
const ConfirmSelections = () => {
		...
		const mockSelections = [
			{
				...
				duration: "6 months",
				notes:
					"Excellent technical skills and communication. Strong portfolio.",
				feedback: "",
			},
			{
				id: 2,
			...
			},
			{
				...
				duration: "6 months",
				notes:
					"Creative designer with good frontend skills. Limited backend knowledge.",
				feedback: "",
			},
			{
				id: 4,
	...
	const pendingCount = selections.filter(
		(s) => s.status === "Pending Confirmation"
	).length;
						...
						>
							...
							<div className="mb-4">
								...
								<textarea
									...
									onChange={(e) =>
										handleFeedbackChange(candidate.id, e.target.value)
									}
									rows={3}

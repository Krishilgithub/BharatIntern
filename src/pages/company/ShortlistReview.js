...
const ShortlistReview = () => {
    ...
    const mockApplications = [
      {
        ...
        location: "Bangalore",
        resumeUrl: "#",
        coverLetter: "I am passionate about frontend development and have been working with React for the past 2 years...",
        projects: [
          {
      ...
      },
      {
        ...
        location: "Mumbai",
        resumeUrl: "#",
        coverLetter: "I have strong backend development skills and experience with various databases...",
        projects: [
          {
            title: "REST API for E-commerce",
            description: "Developed a scalable REST API with authentication and payment integration",
      ...
      },
      {
        ...
        location: "Delhi",
        resumeUrl: "#",
        coverLetter: "I am a creative frontend developer with a passion for user experience...",
        projects: [
          {
      ...
      },
      {
        ...
        location: "Pune",
        resumeUrl: "#",
        coverLetter: "I have a strong background in data science and machine learning...",
        projects: [
          {
  ...
  useEffect(() => {
    ...
    if (filters.posting !== 'all') {
      filtered = filtered.filter(app => app.postingId.toString() === filters.posting);
    }
  ...
  const postings = [...new Set(applications.map(app => ({ id: app.postingId, title: app.postingTitle })))];
          ...
          {showFilters && (
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="grid md:grid-cols-3 gap-4">
                ...
                {/* Posting Filter */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Posting</label>
                  <select
                    value={filters.posting}
                    onChange={(e) => setFilters({...filters, posting: e.target.value})}
                    className="input-field"
                  >
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <div className={`text-2xl font-bold ${getMatchScoreColor(app.matchScore)}`}>
                        {app.matchScore}%
                      </div>
                    </div>
                    ...
                    <div key={index} className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {project.technologies.map((tech, techIndex) => (
                          <span key={techIndex} className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded-full">
                            {tech}
                          </span>
                        ))}
                      </div>

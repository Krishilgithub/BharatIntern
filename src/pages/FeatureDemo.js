...
export default function FeatureDemo() {
	...
	useNotifications((payload) =>
		alert("Notification: " + JSON.stringify(payload))
	);
	...
	const handleFetchAI = () =>
		fetchResults("/api/ai/profile", { user_id: "demo" });
	...
	return (
		<div style={{ padding: 20 }}>
			...
			<div>
				...
				<button onClick={() => emit("chat:message", { text: chatMsg })}>
					Send
				</button>
				<div>
					Log:{" "}
			...
			<div>
				...
				<button onClick={() => alert("Simulate notification received!")}>
					Test Notification
				</button>
			</div>
			<div>

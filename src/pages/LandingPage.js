					...
					<div className="grid md:grid-cols-3 gap-8">
						...
						<div className="card text-center hover:shadow-lg transition-shadow duration-300">
							...
							<p className="text-gray-600 mb-6">
								Upload your resume, get AI-powered recommendations, and track
								your applications.
							</p>
						...
						<div className="card text-center hover:shadow-lg transition-shadow duration-300">
							...
							<p className="text-gray-600 mb-6">
								Create postings, review applications, and manage your internship
								program.
							</p>
							<ul className="text-left text-gray-600 mb-8 space-y-2">
								<li className="flex items-center">
						...
						<div className="card text-center hover:shadow-lg transition-shadow duration-300">
							...
							<p className="text-gray-600 mb-6">
								Manage quotas, run simulations, and oversee the entire
								allocation process.
							</p>
							<ul className="text-left text-gray-600 mb-8 space-y-2">
								<li className="flex items-center">

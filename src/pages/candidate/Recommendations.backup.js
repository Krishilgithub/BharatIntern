		...
		const mockRecommendations = [
			{
				...
				deadline: "2024-02-15",
				description:
					"Join our dynamic team to work on cutting-edge web applications using modern technologies.",
				requirements: [
					"Bachelor's in CS/IT",
			...
			},
			{
				...
				deadline: "2024-02-20",
				description:
					"Work on real-world data science projects and build machine learning models.",
				requirements: [
					"Python proficiency",
			...
			},
			{
				...
				deadline: "2024-02-25",
				description:
					"Learn product management fundamentals and work on real product features.",
				requirements: [
					"Analytical thinking",
			...
			},
			{
				...
				deadline: "2024-02-18",
				description:
					"Build end-to-end web applications and learn modern development practices.",
				requirements: [
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="mb-8">
					...
					<p className="text-gray-600 mt-2">
						Discover personalized internship opportunities that match your

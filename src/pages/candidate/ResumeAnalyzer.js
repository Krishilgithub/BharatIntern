									...
									<div className="flex items-center justify-between">
										<div>
											...
											<p className="text-blue-100">
												Based on skills, experience, and education
											</p>
										</div>
					...
					<div className="space-y-6">
								...
								<div className="flex items-start space-x-3">
									...
									<div>
										...
										<p className="text-gray-600 text-sm">
											Ensure your resume has clear sections and readable fonts
										</p>
									</div>
								</div>
								<div className="flex items-start space-x-3">
									...
									<div>
										...
										<p className="text-gray-600 text-sm">
											List technical skills, programming languages, and tools
										</p>
									</div>
								</div>
								<div className="flex items-start space-x-3">
									...
									<div>
										...
										<p className="text-gray-600 text-sm">
											Include quantifiable results and project outcomes
										</p>
									</div>
								</div>
								<div className="flex items-start space-x-3">
									...
									<div>
										...
										<p className="text-gray-600 text-sm">
											Regularly update your resume with new skills and
											experiences
										</p>
									</div>
								</div>
						...
						<div className="card">
							...
							<p className="text-gray-600 mb-4">
								Download our sample resume template to see the recommended
								format.
							</p>
							...
							<div className="flex items-start space-x-3">
								...
								<div>
									...
									<p className="text-blue-700 text-sm mt-1">
										Your resume is processed securely and is not stored
										permanently. We only extract relevant information for
										analysis purposes.
									</p>
								</div>
							</div>

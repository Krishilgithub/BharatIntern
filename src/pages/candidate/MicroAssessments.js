  ...
  useEffect(() => {
    ...
    const mockAssessments = [
      ...
      },
      {
        ...
        description: "Assess your React skills including components, hooks, state management, and lifecycle.",
        duration: 45,
        questions: 25,
      ...
      },
      {
        ...
        description: "Evaluate your understanding of common data structures and algorithmic thinking.",
        duration: 60,
        questions: 30,
        difficulty: "Advanced",
      ...
      },
      {
        ...
        description: "Test your Python programming skills including syntax, libraries, and best practices.",
        duration: 40,
        questions: 22,
        difficulty: "Intermediate",
      ...
      },
      {
        ...
        description: "Assess your SQL skills for database querying, joins, and optimization.",
        duration: 35,
        questions: 18,
        difficulty: "Intermediate",
      ...
      },
      {
        ...
        description: "Test your understanding of system design principles and scalability concepts.",
        duration: 50,
        questions: 15,
        difficulty: "Advanced",
        skills: ["System Design", "Scalability", "Load Balancing", "Caching", "Microservices"],
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="card mb-6">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div 
                ...
                style={{ width: `${((currentQuestion + 1) / currentAssessment.questions) * 100}%` }}
              ></div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            >
              {currentQuestion === currentAssessment.questions - 1 ? 'Finish' : 'Next'}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">Great job on completing the assessment!</p>
            
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-gray-900">{currentAssessment.questions}</div>
                <div className="text-sm text-gray-600">Total Questions</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-gray-900">{currentAssessment.duration}</div>
                <div className="text-sm text-gray-600">Minutes</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-gray-900">{currentAssessment.attempts + 1}</div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Micro Assessments</h1>
          <p className="text-gray-600 mt-2">
            Test your skills with our comprehensive assessments and track your progress.
          </p>
        </div>
          ...
          <div className="card text-center">
            <div className="text-3xl font-bold text-green-600 mb-2">
              {assessments.filter(a => a.bestScore > 0).length > 0 
                ? Math.round(assessments.filter(a => a.bestScore > 0).reduce((acc, a) => acc + a.bestScore, 0) / assessments.filter(a => a.bestScore > 0).length)
                : 0
              }%
            </div>
            ...
            <div key={assessment.id} className="card hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-900">{assessment.category}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-600">Duration:</span>
                  <span className="font-medium text-gray-900">{assessment.duration} min</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-600">Questions:</span>
                  <span className="font-medium text-gray-900">{assessment.questions}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                ...
                {assessment.bestScore > 0 && (
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={`font-bold ${getScoreColor(assessment.bestScore)}`}>
              ...
              {/* Skills */}
              <div className="mb-4">
                <h4 className="text-sm font-medium text-gray-900 mb-2">Skills Tested:</h4>

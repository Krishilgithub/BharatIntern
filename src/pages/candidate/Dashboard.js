  ...
  useEffect(() => {
    ...
    setNotifications([
      ...
      },
      {
        ...
        message: "You've been shortlisted for Frontend Developer Intern at WebTech Ltd",
        type: "success",
        time: "1 day ago"
      },
      {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Welcome back! Here's what's happening with your internship applications.</p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="card">
              ...
              <div className="flex items-center justify-between text-sm text-gray-600">
                ...
                <Link to="/candidate/resume" className="text-primary hover:text-blue-700 font-medium">
                  Update Profile
                </Link>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link to="/candidate/resume" className="card hover:shadow-lg transition-shadow duration-300 group">
              ...
              <Link to="/candidate/recommendations" className="card hover:shadow-lg transition-shadow duration-300 group">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">View personalized matches</p>
                  </div>
                </div>
              </Link>

              <Link to="/candidate/assessments" className="card hover:shadow-lg transition-shadow duration-300 group">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Take skill assessments</p>
                  </div>
                </div>
              </Link>

              <Link to="/candidate/roadmap" className="card hover:shadow-lg transition-shadow duration-300 group">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Track your skill development</p>
                  </div>
                </div>
              </Link>
            </div>
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link to="/candidate/recommendations" className="text-primary hover:text-blue-700 font-medium">
                  View All
                </Link>
              </div>
                  ...
                  <div key={rec.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-sm transition-shadow">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600 text-sm mb-2">{rec.company} • {rec.location} • {rec.duration}</p>
                      ...
                      <div className="text-right ml-4">
                        <div className="text-2xl font-bold text-primary mb-1">{rec.matchScore}%</div>
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link to="/candidate/applications" className="text-primary hover:text-blue-700 text-sm">
                  View All
                </Link>
              </div>

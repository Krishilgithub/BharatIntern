  ...
  useEffect(() => {
    ...
    const mockRoadmap = [
      {
        ...
        milestones: [
          { title: "Complete Fundamentals", completed: true, date: "2024-01-15" },
      ...
      },
      {
        ...
        milestones: [
          { title: "Complete React Basics", completed: true, date: "2024-01-10" },
    ...
    mockRoadmap.forEach(skill => {
      ...
      progressData[skill.id] = {
        ...
        overall: Math.round(((completedResources + completedMilestones) / (totalResources + totalMilestones)) * 100)
      };
    });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Personalized skill development path based on your career goals and current abilities.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div className="card text-center">
            <div className="text-3xl font-bold text-primary mb-2">{roadmap.length}</div>
          ...
          <div className="card text-center">
            <div className="text-3xl font-bold text-yellow-600 mb-2">
              {roadmap.reduce((acc, skill) => acc + skill.resources.filter(r => r.completed).length, 0)}
            </div>
            <div className="text-gray-600">Resources Completed</div>
          </div>
          <div className="card text-center">
            <div className="text-3xl font-bold text-green-600 mb-2">
              {roadmap.reduce((acc, skill) => acc + skill.milestones.filter(m => m.completed).length, 0)}
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          {roadmap.map((skill) => (
            <div key={skill.id} className="card hover:shadow-lg transition-shadow duration-300">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold text-primary mb-1">{skill.impact}</div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div 
                    className={`h-3 rounded-full transition-all duration-300 ${
                      skill.currentLevel >= skill.targetLevel ? 'bg-green-500' : 'bg-primary'
                    }`}
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="text-center">
                  <div className="text-lg font-bold text-gray-900">{progress[skill.id]?.overall || 0}%</div>
                  <div className="text-xs text-gray-600">Overall Progress</div>
                </div>
                <div className="text-center">
                  <div className="text-lg font-bold text-gray-900">{skill.estimatedTime}</div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                <div className="text-sm text-gray-500">
                  {skill.resources.filter(r => r.completed).length}/{skill.resources.length} resources completed
                </div>
                <button
            ...
            <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">{currentSkill.skill} Learning Path</h2>
                  <button

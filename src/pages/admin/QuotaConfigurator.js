...
const QuotaConfigurator = () => {
	...
	const totalTarget = Object.values(quotas).reduce(
		(sum, quota) => sum + quota.target,
		0
	);
	const totalCurrent = Object.values(quotas).reduce(
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="mb-8">
					...
					<p className="text-gray-600 mt-2">
						Configure and manage reservation quotas for the PM Internship
						Scheme.
					</p>
				</div>
										...
										<div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
											<div className="flex items-center space-x-2">
												...
												<span className="text-sm text-red-700">
													Quota exceeded by {Math.round(quota.percentage - 100)}
													%. Consider adjusting target or current allocation.
												</span>
											</div>
										</div>
									)}
										...
										<div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
											<div className="flex items-center space-x-2">
												...
												<span className="text-sm text-yellow-700">
													Low allocation. Consider increasing target or finding
													more candidates.
												</span>
											</div>
										</div>

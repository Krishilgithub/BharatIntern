				...
				auditTrail: [
					{
						...
						details: "Auto-allocated based on matching algorithm",
					},
					{
						action: "Reviewed",
						user: "Admin User",
					...
					},
					{
						...
						details: "Allocation approved for final processing",
					},
				],
			},
			{
				...
				notes:
					"Good problem-solving skills, needs improvement in system design",
				auditTrail: [
					{
						action: "Allocated",
						user: "System",
					...
					},
					{
						action: "Flagged",
						user: "System",
						timestamp: "2024-02-18 09:16:00",
						details: "Flagged for manual review due to quota constraints",
					},
				],
			},
			{
				...
				auditTrail: [
					...
					},
					{
						action: "Rejected",
						user: "Admin User",
						timestamp: "2024-02-20 15:50:00",
						details: "Rejected due to insufficient technical skills",
					},
				],
			},
			{
				...
				auditTrail: [
					{
						action: "Allocated",
						user: "System",
						timestamp: "2024-02-22 13:20:00",
						details: "Auto-allocated based on matching algorithm",
					},
					{
						action: "Flagged",
						user: "System",
						timestamp: "2024-02-22 13:21:00",
						details: "Flagged for manual review due to quota constraints",
					},
				],
			},
	...
	useEffect(() => {
		...
		if (searchTerm) {
			filtered = filtered.filter(
				(allocation) =>
					allocation.candidateName
						.toLowerCase()
						.includes(searchTerm.toLowerCase()) ||
					allocation.companyName
						.toLowerCase()
						.includes(searchTerm.toLowerCase()) ||
					allocation.postingTitle
						.toLowerCase()
						.includes(searchTerm.toLowerCase()) ||
		...
		if (filters.company !== "all") {
			filtered = filtered.filter(
				(allocation) => allocation.companyName === filters.company
			);
		}

		// Match score filter
		filtered = filtered.filter(
			(allocation) => allocation.matchScore >= filters.matchScore
		);
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="mb-8">
					...
					<p className="text-gray-600 mt-2">
						Review, approve, and manage candidate allocations to internship
						positions.
					</p>
				</div>
							...
							<div className="flex items-center justify-between pt-4 border-t border-gray-200">
								...
								<div className="flex items-center space-x-2">
									<select
										...
										onChange={(e) =>
											handleStatusChange(allocation.id, e.target.value)
										}

        ...
        <div className="min-h-screen bg-gray-50">
          ...
          <main>
            <Routes>
              ...
              <Route path="/candidate/roadmap" element={
                <ProtectedRoute role="candidate">
                  <LearningRoadmap />
                </ProtectedRoute>
              } />
              ...
              <Route path="/company/create-posting" element={
                <ProtectedRoute role="company">
                  <CreatePosting />
                </ProtectedRoute>
              } />
              ...
              <Route path="/company/confirm" element={
                <ProtectedRoute role="company">
                  <ConfirmSelections />
                </ProtectedRoute>
              } />
              ...
              <Route path="/admin/quota-config" element={
                <ProtectedRoute role="admin">
                  <QuotaConfigurator />
                </ProtectedRoute>
              } />
              ...
              <Route path="/admin/batch-matching" element={
                <ProtectedRoute role="admin">
                  <BatchMatching />
                </ProtectedRoute>
              } />
              <Route path="/admin/allocation-review" element={
                <ProtectedRoute role="admin">
                  <AllocationReview />
                </ProtectedRoute>
              } />
